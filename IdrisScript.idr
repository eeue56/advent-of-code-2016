...
-- TAKEN from https://github.com/idris-hackers/IdrisScript/blob/master/IdrisScript.idr
-- but we don't need the whole thing.. so just taking this.
-- their license still applies!
